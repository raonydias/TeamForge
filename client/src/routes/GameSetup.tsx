...
import { SpeciesRow, TagRow } from "../lib/types";
...
export default function GameSetup() {
  ...
  useEffect(() => setSpeciesSet(new Set(allowedSpecies)), [allowedSpecies]);
  useEffect(() => setAbilitiesSet(new Set(allowedAbilities)), [allowedAbilities]);
  useEffect(() => setItemsSet(new Set(allowedItems)), [allowedItems]);
